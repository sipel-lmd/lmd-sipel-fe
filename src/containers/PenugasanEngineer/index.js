...
class PenugasanEngineer extends Component {
    ...
    async loadData() {
        try {
            const orders = await APIConfig.get("https://propen-a01-sipel.herokuapp.com/api/v1/ordersVerified");
            const engineers = await APIConfig.get("https://propen-a01-sipel.herokuapp.com/api/v1/engineers");
